...
import { openEmployerModal, openProjectDetailModal, setSelectedProject} from '@/lib/modalSlice';
...
export default function ProfileExperience({
  ...
  // This handler is for the general View Projects button, which we are removing
    ...
    <section id="experience" className="mb-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          {/* Removed the general View Projects button */}
          {/* <button
      ...
      <div className="mt-6 space-y-4">
        {employers.slice(0, visibleExperiencesCount).map((employer) => {
           // Filter and sort projects for the current employer based on local state
          ...
          const filteredAndSortedProjects = useMemo(() => {
            let projects = employer.projects || [];
            ...
            if (filterCriteria !== 'all') {
              projects = projects.filter(project => project.platform === filterCriteria);
            }
            ...
            return projects;
          }, [employer.projects, searchTerm, sortCriteria, filterCriteria]);
            ...
            >
              ...
              {employer.projects && employer.projects.length > 0 && (
                <div className="mt-4">
                  ...
                  <button
                    className="text-blue-600 hover:underline text-sm font-semibold mb-2"
                    onClick={() => handleToggleProjects(employer.id)}
                  >
                    {expandedEmployerId === employer.id ? 'Hide Projects' : 'Show Projects'}
                  </button>

                  {/* Render projects and controls only if expanded */}
