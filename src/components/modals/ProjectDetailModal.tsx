...
import type { Project } from '@/types'; // Assuming Project type is in types/index.ts
...
export default function ProjectDetailModal({ project, onClose }: ProjectDetailModalProps) {
  // Only show the modal if a project is provided
  const isOpen = !!project;

  // Helper to format numbers (re-used from ProjectsModal)
    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}> {/* Increased z-index */}
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          {/* Background Overlay - light semi-transparent */}
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-colors duration-300">
                {/* Modal Header */}
                ...
                {project && (
                  <div className="mt-2 space-y-4">
                    ...
                    <h4 className="text-xl font-bold text-gray-900 dark:text-white">{project.title}</h4>
                     ...
                     {/* <p className="text-sm text-gray-600 dark:text-gray-300">Role: {project.role}</p> */}
                    ...
                    {project.projectUrl && ( // Assuming a projectUrl field exists for the link
                      <div className="mt-4">
                        <a
                     ...
                     {project.githubUrl && ( // Assuming a githubUrl field exists
                      <div className="mt-4">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600"
                        >
