      ...
      <Dialog as="div" className="relative z-10" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-colors duration-300 overflow-y-auto">
                {/* Modal Header */}
                ...
                <div className="flex items-center space-x-4 mb-6">
                   {/* Search */}
                   <div className="flex items-center flex-grow border border-gray-300 dark:border-gray-600 rounded px-3 py-1">
                        ...
                        <input
                          ...
                          className="flex-grow outline-none text-sm text-gray-900 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400"
                          value={searchTerm}
                    ...
                    <div className="relative">
                        <select
                          className="appearance-none border border-gray-300 dark:border-gray-600 rounded px-3 py-1 text-sm text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline pr-8 bg-white dark:bg-gray-800"
                          value={sortCriteria}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {visibleProjects.map((project) => (
                    <div key={project.id} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-sm bg-white dark:bg-gray-700 transition-colors duration-300">
                      ...
                      />
                      <div className="p-4">
                         <h4 className="text-md font-semibold text-gray-800 dark:text-white">{project.title}</h4>
                         <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Video Editor</p>
